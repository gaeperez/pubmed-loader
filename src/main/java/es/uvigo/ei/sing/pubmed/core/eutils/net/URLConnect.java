package es.uvigo.ei.sing.pubmed.core.eutils.net;
/*
  URLConnect.java
  <p>
...
public class URLConnect {
     ...
     */
    private void retrieveURLOutput(String url, InputStreamParser parser) throws IOException {
     ...
     * @see InputStreamParser
     */
    public void doQuery(InputStreamParser parser) throws IOException {
        if (url == null) {
        ...
        log.info("Connecting to URL " + request.toString());
